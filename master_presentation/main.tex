...
\begin{document}
    ...
    \only<1>{
        ...
        \begin{column}{0.7\textwidth}
            \begin{figure}[h]
            \centering
            \includegraphics[width=0.9\linewidth]{master_presentation/figures/interpAccuracy.png}
            \caption{Qualitative illustration of the tradeoff between accuracy and interpretability in a set of common ML models.}
            \label{Fig:InterpretabilityVsAccuracy}
            \end{figure}
        \end{column}
    ...
    \only<1>{
        ...
        \begin{column}{0.7\textwidth}
            \begin{figure}
            \centering
            \includegraphics[width=0.99\linewidth]{master_presentation/figures/blackBox.png}
            \label{fig:blacBox}
            \end{figure}
        \end{column}
        \end{columns}
    ...
    \begin{frame}[fragile]{XAI — How?}
        ...
        \begin{column}{0.7\textwidth}
            \begin{figure}[h]
            \centering
            \includegraphics[width=0.55\linewidth]{master_presentation/figures/MLsystemMeme.png}
    ...
    \begin{frame}[fragile]{Generative Modelling with Diffusion Models}
        \begin{figure}[h]
        \centering
        \includegraphics[width=0.68\linewidth]{master_presentation/figures/imagenExamples2.png}
    ...
    \begin{frame}[fragile]{Diffusion Models — How?}
        ...
        \begin{figure}[h]
        \centering
        \includegraphics[width=0.9\linewidth]{master_presentation/figures/diffProcessIllustration.png}
        ...
        \only<2>{
            \begin{figure}[h]
            \centering
            \includegraphics[width=0.99\linewidth]{master_presentation/figures/gaussianForwardProcess.pdf}
        ...
        \only<3>{
            \begin{figure}[h]
            \centering
            \includegraphics[width=0.99\linewidth]{master_presentation/figures/multinomialForwardProcess.pdf}
    ...
    \begin{frame}[fragile]{Some Results}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.5\linewidth]{master_presentation/figures/TabDDPM_Qual_AD_joint.pdf}
